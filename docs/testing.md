...
Vitest covers ISO week boundaries, Monday–Sunday generation, duration parse/format, state transitions, entry validity, trusted totals, multiple codes per date, manager/organization authorization, report aggregation, and project isolation.
